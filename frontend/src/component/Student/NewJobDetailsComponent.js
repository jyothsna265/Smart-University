...
class NewJobDetailsComponent extends Component {
    constructor(props) {
        ...
        return (
            <div class="jobcomp-div" >
                <div class="jobcomp-innerdiv">
                    ...
                    <div>
                        <button class="jobs-btn" data-toggle="modal" data-target="#exampleModalCenter">Apply</button>
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="exampleModalLongTitle">Apply to {this.state.title} position at {this.state.company}</h3>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" onClick={this.uploadHandler} class="btn btn-primary">Submit</button>
                            </div>
                            </div>
                        </div>
                    </div>
...
export default connect(mapStateToProps,mapDispatchToProps)(NewJobDetailsComponent);
